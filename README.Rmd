...
The `targetthis` package provides a Shiny widget to help build a `targets` pipeline. The `targets` package is documented in [The {targets} R package user manual](https://books.ropensci.org/targets/)
